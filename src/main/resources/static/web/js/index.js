$(function () {
    ...
    $('#callbacks2').selectric({
        onChange: function() {
            window.open($(this).val());
        }
    });
    $('#callbacks3').selectric({
        onChange: function() {
            window.open($(this).val());
        }
    });
    $('#callbacks4').selectric({
        onChange: function() {
            window.open($(this).val());
        }
    });
...
function navLiHover() {
    $(".nav-li").each(function (index, element) {
        $(this).hover(function () {
            $(this).css("background", "url('/static/web/img/cloud.png') top center no-repeat");
            $(this).find("a").eq(0).css("color", "#002a89");
        }, function () {
